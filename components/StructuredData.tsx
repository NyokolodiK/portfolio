...
export default function StructuredData() {
  const structuredData = {
    ...
    jobTitle: 'Principal Frontend Engineer & AI Product Engineering',
    worksFor: {
      '@type': 'Organization',
      name: 'NTT DATA, Inc.',
    },
    ...
    description:
      'Results-driven Principal Frontend Engineer & AI Product Engineering with expertise in building high-performance web applications. Specializing in React, Next.js, TypeScript, AI integration, and scalable system design.',
  }
  ...
  const websiteStructuredData = {
    ...
    url: 'https://www.kagiso-nyokolodi.dev',
    description:
      'Professional portfolio of Kagiso Nyokolodi, a Principal Frontend Engineer & AI Product Engineering specializing in frontend development, AI integration, and scalable systems.',
    author: {
      '@type': 'Person',
      name: 'Kagiso Nyokolodi',
    },
